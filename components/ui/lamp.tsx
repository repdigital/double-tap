...
export const LampContainer = ({
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#002914" }} // Changed background to #002914
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          <div
            ...
            style={{
              background: `conic-gradient(from 70deg at center top, rgba(3, 135, 62, 0.4) 0deg, transparent 50deg, transparent 310deg, rgba(3, 135, 62, 0.4) 360deg)`,
            }}
          />
          <div
        ...
        >
          <div
            ...
            style={{
              background: `conic-gradient(from 290deg at center top, transparent 0deg, transparent 50deg, rgba(3, 135, 62, 0.4) 70deg, transparent 120deg)`,
            }}
          />
          <div
        ...
        <div
          ...
          style={{ backgroundColor: "rgba(3, 135, 62, 0.4)" }}
        ></div>
        <motion.div
          initial={{ width: "8rem" }}
